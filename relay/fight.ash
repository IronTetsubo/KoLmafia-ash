...
//         case $location[]: actbox.append(""); break;
         ...
         case $location[defiled nook]: if (item_amount($item[evil eye]) > 0) abox.append("<p><a href=# class='clilink' title='use * evil eye'><img src='/images/itemimages/zomboeye.gif' class=hand onClick='descitem(272996974)' border=0></a>");
